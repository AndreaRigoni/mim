...
static void create_services(AvahiClient *c) {
    ...
    if (avahi_entry_group_is_empty(group)) {
        ...
        snprintf(random_data, sizeof(random_data), "random=%i", rand());

        /* Add the service for MIM */
                                                 ...
                                                 NULL)) < 0)
        {
            ...
            fprintf(stderr, "Failed to add _mim_registry._tcp service: %s\n", avahi_strerror(ret));
            goto fail;
        }
...
//    avahi_free(name);
//    name = avahi_strdup("Modified Mim_registry");
...
int main(AVAHI_GCC_UNUSED int argc, AVAHI_GCC_UNUSED char*argv[]) {
    ...
    // name = avahi_strdup("Mim_registry");
    name = hostname;
